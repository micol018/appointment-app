    ...
    return (
        <li className='px-3 py-3 flex items-start'>
            ...
            <div className='flex items-center'>
                <span className='flex-none font-medium text-3xl text-amber-400'>{appointment.petName}</span>
                <span className='flex-grow text-right'>{appointment.aptDate}</span>
            </div>
            <div><b className='font-bold text-blue-400'>Owner: </b>{appointment.ownerName}</div>
